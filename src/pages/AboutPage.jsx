          ...
          <div className="row">
            ...
            <div className="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
              ...
              <div className="row">
                ...
                <p>
                  When I started to learn programming, I felt like this was
                  where I belonged for the first time. My passion for coding was
                  ignited through self-guided programming courses, and from that
                  point onward, I was captivated by the art of bringing ideas to
                  life through code and its immense satisfaction.
                </p>
                <p>
                  My ambition is to continually evolve into a proficient
                  developer, dedicated to crafting innovative IT solutions that
                  enhance user experiences and simplify their daily lives.
                </p>
              </div>
            </div>
          </div>
